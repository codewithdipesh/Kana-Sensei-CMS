...
export default function PageEditor({ page, onSave }: PageEditorProps) {
  ...
  const handleSave = () => {
    ...
    if (pageType === "ANIMATION" && !formData.kanaSelect) {
      errors.push("Select Kana is required for animations")
    }

    if (pageType === "PRACTICE" && !formData.kanaSelect) {
      errors.push("Select Kana is required for practice")
    }

    if (pageType === "QUIZ") {
      if (!formData.question.trim()) {
        errors.push("Question is required for quizzes")
      }
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                onChange={(e) => handleInputChange("kanaSelect", e.target.value)}
            ...
            <div className="bg-gray-100 rounded-lg p-6 text-center">
              ...
              <button className="mt-4 bg-purple-500 text-white px-4 py-2 rounded text-sm font-medium hover:bg-purple-600 transition-colors">
                ▶ Play Audio
              </button>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-2">
              ...
              <div className="text-sm space-y-1">
                <p>
                  <span className="font-semibold">Romaji:</span> a
                </p>
                <p>
                  <span className="font-semibold">Example:</span> Apple
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => handleInputChange("correctOption", Number.parseInt(e.target.value))}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"
              >
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="relative">
            <select
              ...
              className={`appearance-none px-3 py-2 pr-8 text-xs sm:text-sm font-semibold text-white rounded focus:outline-none focus:ring-2 cursor-pointer ${getPageTypeColor(pageType)} hover:opacity-90`}
            >
      ...
      <div className="border-t border-gray-200 p-4 sm:p-6 bg-gray-50">
        <button
          onClick={handleSave}
          className="w-full bg-blue-500 text-white px-4 py-2 sm:py-3 rounded-lg text-sm sm:text-base font-medium hover:bg-blue-600 transition-colors flex items-center justify-center gap-2"
        >
